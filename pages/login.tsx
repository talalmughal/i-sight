...
export default function Login() {
  ...
  return (
    ...
    >
      ...
      <div
        className="flex flex-col justify-center items-center px-6 py-12 sm:py-0 lg:px-16 w-screen sm:w-[488px] h-screen sm:h-[580px] rounded-md"
        style={{
          background:
          ...
          <div className="">
            <form className="space-y-9" action="" method="POST">
              ...
              <div className="pt-5">
                <button
                  type="submit"
                  className="flex w-full h-12 justify-center items-center rounded-md bg-white text-blue-500 text-base font-bold"
                >
                  Sign in
                </button>
              </div>
