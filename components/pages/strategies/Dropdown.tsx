...
export const Dropdown = ({
  ...
  return (
    ...
    >
      ...
      >
        <Menu.Items className="absolute left-0 z-10 mt-2 w-full max-w-3xl h-auto max-h-52 origin-top-right rounded-md bg-[#262932] shadow-lg focus:outline-none overflow-auto">
